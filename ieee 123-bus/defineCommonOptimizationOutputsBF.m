...
Network.Optimization.Variables.InmPrime3Phi=full(InmPrime3Phi);
...
Network.Optimization.Variables.InmPrime2Phi=full(InmPrime2Phi);
...
Network.Optimization.Variables.InmPrime1Phi=full(InmPrime1Phi);
...
Network.Optimization.Variables.VnmPrime2Phi=full(VnmPrime2Phi); 
Network.Optimization.Variables.SnmPrime2Phi=full(SnmPrime2Phi);
Network.Optimization.Variables.VnmPrime1Phi=full(VnmPrime1Phi); 
Network.Optimization.Variables.SnmPrime1Phi=full(SnmPrime1Phi);
...
Network.Optimization.PlaceHolders.WPrime2Phi=full(WPrime2Phi);
Network.Optimization.PlaceHolders.WPrime1Phi=full(WPrime1Phi);
...
Network.Optimization.L2L1=(mean(Network.Optimization.Constraints.BranchConstraints.W3PhiLambdas(end-1,:)...
     ...
     mean(Network.Optimization.Constraints.BranchConstraints.W2PhiLambdas(end-1,:)...
     ./Network.Optimization.Constraints.BranchConstraints.W2PhiLambdas(end,:))+...
     mean(Network.Optimization.Constraints.BranchConstraints.W1PhiLambdas(end-1,:)...
     ./Network.Optimization.Constraints.BranchConstraints.W1PhiLambdas(end,:)))./3;
