...
Network.Optimization.Variables.WnnPrime2Phi=full(WnnPrime2Phi); 
Network.Optimization.Variables.WnmPrime2Phi=full(WnmPrime2Phi);
Network.Optimization.Variables.WnnPrime1Phi=full(WnnPrime1Phi); 
Network.Optimization.Variables.WnmPrime1Phi=full(WnmPrime1Phi);
